...
import { Frame, LucideIcon, Minimize, Scan } from "lucide-react";
import {
  createContext,
  Dispatch,
  ReactNode,
...
> = {
  fullwidth: { displayName: "Fullwidth", icon: Scan },
  centered: { displayName: "Centered", icon: Minimize },
  unset: { displayName: "Unset", icon: Frame },
};
